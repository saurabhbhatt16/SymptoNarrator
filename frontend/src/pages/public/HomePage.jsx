...
import heroDocPatient from "../../assets/docpatient.jpg";
...
const serviceItems = [
  {
    ...
    description:
      "Describe your symptoms and receive a fast AI-guided clinical summary.",
  ...
  },
  {
    ...
    description:
      "Choose specialists, compare time slots, and confirm in seconds.",
  ...
  },
  {
    ...
    description:
      "Generate and store clean medical reports for future consultations.",
  ...
  },
  {
    ...
    description:
      "Connect securely with doctors through guided in-app messaging.",
  ...
  },
  {
    ...
    description:
      "Meet your doctor face-to-face through stable virtual sessions.",
...
const steps = [
  {
    ...
    description:
      "Answer a few guided questions so our AI can understand your condition clearly.",
  ...
  },
  {
    ...
    title: "Get AI Report",
    description:
      "Receive a concise report with key observations and care recommendations.",
    icon: HiOutlineDocumentReport,
  },
  {
    number: 3,
    ...
    description:
      "Share your report with a certified doctor and continue with informed treatment.",
...
const testimonials = [
  {
    id: 1,
    name: "Aarav Sharma",
    feedback: "The symptom summary helped my doctor diagnose faster than ever.",
    rating: 5,
  },
  {
    id: 2,
    name: "Priya Mehta",
    feedback: "Booking and follow-up chat were smooth and very reassuring.",
    rating: 5,
  },
  {
    id: 3,
    name: "Ananya Iyer",
    feedback:
      "I felt supported through every step, especially during video visits.",
    rating: 4,
  },
  {
    id: 4,
    name: "Rohan Verma",
    feedback: "Clear reports made it easy to track my recovery progress.",
    rating: 5,
  },
  {
    id: 5,
    name: "Kavya Nair",
    feedback: "The platform saved me time and reduced clinic waiting stress.",
    rating: 4,
  },
  {
    id: 6,
    name: "Arjun Kapoor",
    feedback: "Excellent experience, from symptom input to doctor connection.",
    rating: 5,
  },
  {
    id: 7,
    name: "Diya Sinha",
    feedback: "I appreciate the clean interface and practical care guidance.",
    rating: 5,
  },
  {
    id: 8,
    name: "Vihaan Kulkarni",
    feedback: "Quick, reliable, and very professional telehealth support.",
    rating: 4,
  },
  {
    id: 9,
    name: "Meera Joshi",
    feedback: "It helped me explain my symptoms accurately before my consult.",
    rating: 5,
  },
];
...
function HomePage() {
  ...
  return (
    <div
      id="top"
      className="min-h-screen bg-linear-to-b from-sky-50/70 via-white to-emerald-50/50 text-slate-900"
    >
      <HomeNavbar />

      <main>
        <section className="relative overflow-hidden bg-linear-to-r from-blue-50 via-white to-white">
          <div className="pointer-events-none absolute -left-20 top-14 h-60 w-60 rounded-full bg-sky-200/35 blur-3xl" />
          <div className="pointer-events-none absolute -right-24 top-24 h-64 w-64 rounded-full bg-blue-200/35 blur-3xl" />

          <div className="mx-auto grid min-h-135 w-full max-w-7xl items-center px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-20">
            <div className="flex h-full items-center animate-[fadeIn_0.7s_ease-out]">
              <div>
                ...
                <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
                  SymptoNarrator helps you describe symptoms better, get faster
                  medical clarity, and connect with trusted doctors from
                  anywhere.
                </p>
            ...
            <div className="relative mt-12 flex h-full items-center justify-end lg:mt-0 lg:pl-6 animate-[fadeIn_0.9s_ease-out]">
              <div className="pointer-events-none absolute inset-y-0 left-0 hidden w-24 bg-linear-to-r from-blue-50 via-white/90 to-transparent blur-2xl lg:block" />
              <img
                src={heroDocPatient}
                alt="Doctor discussing care with a patient"
                className="relative z-10 h-100 w-full rounded-xl border border-slate-100/60 object-cover shadow-none sm:h-110"
              />
            </div>
          </div>
        </section>
        ...
        <section
          id="services"
          className="mx-auto w-full max-w-7xl scroll-mt-24 px-4 py-16 sm:px-6 lg:px-8 lg:py-20"
        >
        ...
        <section
          id="how-it-works"
          className="scroll-mt-24 bg-slate-50/70 py-16 lg:py-20"
        >
        ...
        <section
          id="about"
          className="mx-auto w-full max-w-7xl scroll-mt-24 px-4 pb-16 sm:px-6 lg:px-8 lg:pb-20"
        >
          <div className="overflow-hidden rounded-3xl bg-linear-to-r from-sky-600 via-sky-700 to-emerald-600 p-8 text-center text-white shadow-2xl shadow-sky-200 sm:p-12">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-sky-50 sm:text-base">
              Join thousands of users who start with better symptom narration
              and move toward faster, confident clinical care.
            </p>
            <Link
              to="/login"
