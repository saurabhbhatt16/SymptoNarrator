        ...
        dispatch(
          setAuth({
            user: {
              ...
              isVerified: Boolean(
                response.profile.isVerified || response.profile.verified,
              ),
              needsOnboarding: false,
            },
            role,
          ...
          <section className="mt-6 grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Your public-facing doctor profile details.
                    </p>
                  </div>
                  <button
                    type="button"
              ...
              <div className="rounded-xl border border-dashed border-slate-200 bg-white p-5 text-sm text-slate-600 shadow-lg">
                Keep your profile image, specialization, and contact details up
                to date so patients and admin can verify your practice
                information quickly.
              </div>
            </div>
          </section>
